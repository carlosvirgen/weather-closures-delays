...
var defaultTableOptions = {
    ...
    spreadsheetKey: '0AtTBLFv0FHqodHc5aUFQLVlPQWwyRGNGdnpzd2w4UVE',

    // add the path to a flat json file if the dataSource is set to flatfile.
    jsonFile: 'static-files/data/ct_pensions_2012.json',
    ...
    dataHeaders: ['name', 'citytown', 'details'],

    // proper display names as you want them to appear in the table
    columnHeaders: ['Affected', 'Town', 'Details'],
